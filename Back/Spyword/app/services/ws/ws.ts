...
import type { TypeUser, WsMessages, Action, InfoUser, Alert, AnimationName } from './ws.model.js'
...
export function transmitUser(id: number, type: 'animate', data: AnimationName): void
